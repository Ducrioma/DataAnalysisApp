---
title: "Data Analytics - Shainy App"
...
- For the sake of simplicity we have only selected Western European cities for the moment.
            ...
            sample_cities <- c('Mallorca','Antwerp','Sevilla','Naploli')
...
First you can compare any metric over all the neigborhoods, the room types and the numbers of bedrooms at the same time.
![](finer.png)
...
- Currently the App is limited to **5** cities for memory purposes
...
- We shared this app in a simplified version on https://karhyus.shinyapps.io/final_projet_sorrin_marini_barras/ and the whole project is available on //////
